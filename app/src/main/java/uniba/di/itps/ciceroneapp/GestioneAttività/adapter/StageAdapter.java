...
public class StageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewUpdate= (TextView) convertView.findViewById(R.id.textViewUpdate);
        TextView textViewDelete= (TextView) convertView.findViewById(R.id.textViewDelete);
